...
def time_execution(function,inputs):
    start=time.clock()
    result =function(inputs) #change to *inputs for iterable inputs from a function
...
print time_execution(factorial,50)
# 3.099999999999978e-05
